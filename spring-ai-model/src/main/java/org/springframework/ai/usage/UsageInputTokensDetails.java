...
/**
 * Per-modality input token usage.
 *
 * @author peatboy
 * @since 2.0.0
 */
public class UsageInputTokensDetails {
	...
	public boolean equals(@Nullable Object o) {
		...
		if (!(o instanceof UsageInputTokensDetails that)) {
			return false;
		}
	...
	public String toString() {
		return "UsageInputTokensDetails{" + "imageTokens=" + this.imageTokens + ", textTokens=" + this.textTokens
